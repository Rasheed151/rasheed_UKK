            ...
            <div class="div m-8 w-1/2">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="my-4 text-2xl">
                        ...
                        <input type="email" name="email" placeholder="Email" class="border rounded-sm my-2">
                    </div>
                    <div class="my-4 text-2xl">
                    ...
                    <div class="flex justify-center m-4 text-2xl">
                        <button type="submit" class="bg-[#06402B] px-2 py-1 rounded-sm font-normal text-white">Registrasi</button>
                    </div>
                </form>
                <div class="flex justify-center">
                    <h6>Atau <a href="login" class="decoration-sky-500 font-light">Login</a></h6>
                </div>
            </div>
        </div>
    </div>
